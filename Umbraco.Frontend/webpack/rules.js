  ...
  const scss = {
    ...
    use: [
      ...
      // },
      {
        ...
        options: {
          resources: [
            path.resolve(__dirname, '../src/styles/resources/variables/*.scss'),
            path.resolve(__dirname, '../src/styles/resources/functions/*.scss'),
            path.resolve(__dirname, '../src/styles/resources/mixins/*.scss'),
          ]
        },
      },
    ],
